...
/*
 * modified from here:
 * https://www.sapien.com/forums/viewtopic.php?t=8662
 */
using System;
using System.Windows.Forms;
using System.Reflection;
namespace Scripting.PoweShell {
    public class DirectoryDialog {
        ...
        public string Title {
            ...
            set {
                _ofd.Title = string.IsNullOrWhiteSpace(value) ? "Select directory" : value;
            }
        }
...
'@
    ...
    $fsd = New-Object Scripting.PoweShell.DirectoryDialog;
    $fsd.Title = $title;
