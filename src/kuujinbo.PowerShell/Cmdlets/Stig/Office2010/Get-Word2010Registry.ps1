...
function Get-Word2010Registry {
    ...
    @{
        ...
        'SV-34100r2_rule' = @('HKCU:\Software\Policies\Microsoft\Office\14.0\word\security\fileblock', 'WordXPFiles', '5')
        ...
        'SV-34099r2_rule' = @('HKCU:\Software\Policies\Microsoft\Office\14.0\word\security\fileblock', 'Word97Files', '5')
