...
function Get-RegistryRules {
    @{
        ...
        'V-63329' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\Installer\', 'SafeForScripting', '0 (or if the Value Name does not exist)');
        ...
        'V-63581' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\WcmSvc\GroupPolicy\', 'fMinimizeConnections', '1 (or if the Value Name does not exist)');
        ...
        'V-63597' = @('HKLM:SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\', 'LocalAccountTokenFilterPolicy', '0x00000000 (0)');
        ...
        'V-63607' = @('HKLM:\SYSTEM\CurrentControlSet\Policies\EarlyLaunch\', 'DriverLoadPolicy', '1, 3, or 8 (or if the Value Name does not exist)');
        ...
        'V-63627' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters\', 'DevicePKInitEnabled', '1 (or if the Value Name does not exist)');
        ...
        'V-63661' = @('HKLM:\SYSTEM\CurrentControlSet\Services\Netlogon\Parameters\', 'MaximumPasswordAge', '0x0000001e (30)  (or less, excluding 0)');
        ...
        'V-63669' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\', 'InactivityTimeoutSecs', '0x00000384 (900)');
        'V-63671' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer\', 'NoAutorun', '1');
        'V-63673' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\policies\Explorer\', 'NoDriveTypeAutoRun', '0x000000ff (255)');
        ...
        'V-63681' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\', 'LegalNoticeCaption', 'See message title above');
        'V-63683' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection\', 'AllowTelemetry', '0x00000000 (0) (Security), 0x00000001 (1) (Basic)');
        'V-63685' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\System\', 'EnableSmartScreen', '0x00000001 (1)');
        'V-63687' = @('HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\', 'CachedLogonsCount', '10 (or less)');
        'V-63689' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer\', 'NoDataExecutionPrevention', '0 (or if the Value Name does not exist)');
        'V-63691' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer\', 'NoHeapTerminationOnCorruption', '0x00000000 (0) (or if the Value Name does not exist)');
        'V-63695' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer\', 'PreXPSP2ShellProtocolBehavior', '0 (or if the Value Name does not exist)');
        'V-63697' = @('HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\', 'SCRemoveOption', '1 (Lock Workstation) or 2 (Force Logoff)');
        'V-63699' = @('HKLM:\SOFTWARE\Policies\Microsoft\MicrosoftEdge\PhishingFilter\', 'PreventOverride', '0x00000001 (1)');
        'V-63701' = @('HKLM:\SOFTWARE\Policies\Microsoft\MicrosoftEdge\PhishingFilter\', 'PreventOverrideAppRepUnknown', '0x00000001 (1)');
        'V-63703' = @('HKLM:\SYSTEM\CurrentControlSet\Services\LanmanWorkstation\Parameters\', 'RequireSecuritySignature', '1');
        'V-63705' = @('HKLM:\SOFTWARE\Policies\Microsoft\MicrosoftEdge\Main\', 'AllowInPrivate', '0x00000000 (0)');
        ...
        'V-63715' = @('HKLM:\SYSTEM\CurrentControlSet\Services\LanManServer\Parameters\', 'autodisconnect', '0x0000000f (15) (or less)');
        ...
        'V-63721' = @('HKLM:\SOFTWARE\Policies\Microsoft\PassportForWork\PINComplexity\', 'MinimumPINLength', '6 (or greater)');
        ...
        'V-63747' = @('HKLM:\SOFTWARE\Policies\Microsoft\Internet Explorer\Feeds\', 'AllowBasicAuthInClear', '0 (or if the Value Name does not exist)');
        ...
        'V-63795' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\Kerberos\Parameters\', 'SupportedEncryptionTypes', '0x7ffffff8 (2147483640)');
        ...
        'V-63805' = @('HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\MSV1_0\', 'NTLMMinClientSec', '0x20080000 (537395200)');
        'V-63807' = @('HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\MSV1_0\', 'NTLMMinServerSec', '0x20080000 (537395200)');
        ...
        'V-63819' = @('HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System\', 'ConsentPromptBehaviorAdmin', '2 (Prompt for consent on the secure desktop)');
        ...
        'V-63841' = @('HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Attachments\', 'SaveZoneInformation', '0x00000002 (2) (or if the Value Name does not exist)');
        'V-65681' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeliveryOptimization\', 'DODownloadMode', '0x00000000 (0) - No peering (HTTP Only)');
        ...
        'V-71763' = @('HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\Wdigest\', 'UseLogonCredential', '0x00000000 (0)');
        'V-71765' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\Network Connections\', 'NC_ShowSharedAccessUI', '0x00000000 (0)');
        'V-71769' = @('HKLM:\SYSTEM\CurrentControlSet\Control\Lsa\', 'RestrictRemoteSAM', 'O:BAG:BAD:(A;;RC;;;BA)');
        'V-71771' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent\', 'DisableWindowsConsumerFeatures', '0x00000001 (1)');
        'V-72329' = @('HKLM:', 'SuppressionPolicy', '0x00001000 (4096)');
        ...
        'V-74417' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\GameDVR\', 'AllowGameDVR', '0x00000000 (0)');
        'V-74699' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows\CredentialsDelegation\', 'AllowProtectedCreds', '0x00000001 (1)');
        'V-74723' = @('HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters\', 'SMB1', '0x00000000 (0)');
        'V-74725' = @('HKLM:\SYSTEM\CurrentControlSet\Services\mrxsmb10\', 'Start', '0x00000004 (4)');
        'V-77025' = @('HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender Security Center\App and Browser protection\', 'DisallowExploitProtectionOverride', '0x00000001 (1)');
    };
}
